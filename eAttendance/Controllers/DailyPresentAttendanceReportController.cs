...
namespace eAttendance.Controllers
{
    ...
    {
        //
        public ActionResult DailyPresentAttendanceReport(string nLogDate, int officeId = 0)
        {
            ...
            if (model.OfficeId > 0)
            {
                ...
                foreach (EmployeeAttendanceList models in source)
                {
                    ...
                    item.EmployeeNameAndCodeNp = models.EmployeeNameAndCodeNp;
        ...
        public ActionResult DailyPresentAttendanceReport(EmployeeAttendanceList model)
        {
            DateTime date = DateTime.Now.Date;
            ...
            list = (from x in list
                    ...
                    select x).ToList<EmployeeAttendanceList>();
            model.EmployeeAttendanceLists = list;
            return base.PartialView("_DailyPresentAttendance", model);
        }
    }
}